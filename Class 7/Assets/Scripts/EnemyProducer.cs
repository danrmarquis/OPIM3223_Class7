...
public class EnemyProducer : MonoBehaviour
{
    ...
    {
        float x = Random.RandomRange(spawnArea.min.x, spawnArea.max.x);
        float z = Random.RandomRange(spawnArea.min.z, spawnArea.max.z);
        float y = 0.5f;
    ...
    void spawnEnemy()
    {
        ...
        int index = Random.RandomRange(0, enemyPrefabs.Length);
